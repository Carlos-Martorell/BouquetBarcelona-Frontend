...
const mockOrders: Order[] = [
  {
    ...
    items: [
      { flowerId: 'flower1', flowerName: 'Ramo Primaveral', quantity: 2, price: 35 }
    ],
    total: 70,
    status: 'pending',
  ...
  },
  {
    ...
    items: [
      { flowerId: 'flower2', flowerName: 'Ramo Romántico', quantity: 1, price: 45 }
    ],
    total: 45,
    status: 'confirmed',
    deliveryDate: '2025-11-28',
...
const newOrderData: CreateOrder = {
  ...
  items: [
    { flowerId: 'flower3', flowerName: 'Ramo Elegante', quantity: 1, price: 55 }
  ],
  total: 55,
  status: 'pending',
